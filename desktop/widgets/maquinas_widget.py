...
class MaquinasWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_novo = QPushButton("+ Nova Máquina")
        self.btn_novo.setFixedHeight(40)
        self.btn_novo.clicked.connect(self.nova_maquina)
        ...
        headers = ["ID", "Nome", "Modelo", "Empresa", "Departamento", "Status"]
        ...
        self.btn_editar.clicked.connect(self.editar_maquina)
        acoes.addWidget(self.btn_editar)
        
        self.btn_deletar = QPushButton("🗑️ Deletar")
        self.btn_deletar.clicked.connect(self.deletar_maquina)
        acoes.addWidget(self.btn_deletar)
